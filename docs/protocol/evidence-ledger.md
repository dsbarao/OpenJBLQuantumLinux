...
| EVT-031 | 2026-09-16 | Windows 11 VM / QuantumENGINE / 0ecb:2069 | Change microphone gain from 100% to 50%, then restore | `63dfa243e16ef5cca44bdcc62c1a3a1b1c9d3dd02fa19b4703c16335e705f70a` | No HID or USB Audio control transfer occurred; gain is host-side | Confirmed negative |
| EVT-032 | 2026-09-16 | Windows 11 VM / QuantumENGINE / 0ecb:2069 | Change microphone EQ from Natural to Bright, then restore | `4a542c2b8f0f4fecd3bee277b98e1f9ae72b1b0dc57087c9bffb16cccc288627` | No USB transfer occurred; microphone EQ is host-side DSP | Confirmed negative |
| EVT-033 | 2026-09-16 | Windows 11 VM / QuantumENGINE / 0ecb:2069 | Enable ANC, select TalkThru, then disable ambient control | `dccfc975096f7e60b711d2def039aac357a7a356b8b73c6e9601d61b5c7ce724` | Feature Report `0x46` values `01/02/00`, confirmed by Input Report `0x02` | Confirmed |
